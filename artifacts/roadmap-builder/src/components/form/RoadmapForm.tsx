...
import { RoadmapMode, PhaseRoadmapData, ImplementationRoadmapData, Phase, PhaseSubItem, Swimlane, Task, Milestone, ImplementationMilestone, ItemStatus } from '@/types/roadmap';
  ...
  return (
    <div className="flex gap-0.5 text-[9px]">
      <button
        ...
        style={value === 'done' ? { backgroundColor: 'var(--status-done-border)' } : {}}
      ...
      <button
        ...
        style={value === 'in-progress' ? { backgroundColor: 'var(--status-inprogress-border)' } : {}}
      ...
      <button
        ...
        style={value === 'backlog' ? { backgroundColor: 'var(--status-backlog-border)' } : {}}
        data-testid={`status-backlog`}
      >
        Бэклог
      </button>
    </div>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <Label className="text-xs font-medium">Периоды</Label>
              <Button
                variant="ghost"
                size="sm"
          ...
          {mode === 'phase' && (
            <>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-medium">Этапы</Label>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={addPhase}
                            ...
                            <div className="px-2 pb-2 space-y-2 border-t border-border pt-2">
                              <div className="grid grid-cols-1 gap-2">
                                <div className="space-y-1">
                                  <Label className="text-[10px]">Номер</Label>
                                  <Input
                                    type="number"
                                    value={phase.number}
                                    onChange={(e) =>
                              ...
                              <div className="space-y-1">
                                <div className="flex items-center justify-between">
                                  <Label className="text-[10px]">Задачи</Label>
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                    ...
                                    >
                                      ...
                                      <div className="grid grid-cols-2 gap-1">
                                        <div className="space-y-0.5">
                                          <Label className="text-[9px]">Начало</Label>
                                          <Select
                                        ...
                                        <div className="space-y-0.5">
                                          <Label className="text-[9px]">Конец</Label>
                                          <Select
                                      ...
                                      <div className="space-y-0.5">
                                        <Label className="text-[9px]">Статус</Label>
                                        <StatusToggle
                                          value={item.status}
                                          onChange={(status) =>
                                            updateSubItem(phase.id, item.id, { status })
                                          }
                                        />
                                      </div>
                                    </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-medium">Вехи</Label>
                  <Button
                    variant="ghost"
                    size="sm"
                  ...
                  {phaseData.milestones.map((milestone) => (
                    <div key={milestone.id} className="bg-muted/50 rounded p-2 space-y-1.5">
                      ...
                      <div className="grid grid-cols-2 gap-1.5">
                        <div className="space-y-0.5">
                          <Label className="text-[10px]">Период</Label>
                          <Select
                        ...
                        <div className="space-y-0.5">
                          <Label className="text-[10px]">Строка этапа</Label>
                          <Select
          ...
          {mode === 'implementation' && (
            <>
                ...
                <div className="space-y-1.5">
                  {implementationData.milestones.map((milestone) => (
                    <div key={milestone.id} className="bg-muted/50 rounded p-2 space-y-1.5">
                      <div className="flex gap-1.5">
                        <Input
                          placeholder="НАЗВАНИЕ (ЗАГЛАВНЫЕ)"
                          value={milestone.label}
                          onChange={(e) =>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-medium">Потоки работ</Label>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={addSwimlane}
                                  ...
                                  {swimlane.tasks.map((task) => (
                                    ...
                                    >
                                      ...
                                      <div className="grid grid-cols-2 gap-1">
                                        ...
                                        <div className="space-y-0.5">
                                          <Label className="text-[9px]">Длительность</Label>
                                          <Input
                                            type="number"
                                            min="1"
                                            value={task.span}
                                      ...
                                      <div className="space-y-0.5">
                                        ...
                                        <StatusToggle
                                          value={task.status}
                                          onChange={(status) =>
                                            updateTask(swimlane.id, task.id, { status })
                                          }
                                        />
                                      </div>
                                    </div>
